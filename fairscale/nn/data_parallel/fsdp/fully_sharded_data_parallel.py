...
import fairscale.nn.data_parallel.fsdp.ssd_offload as ssd_offload
...
class FullyShardedDataParallel(nn.Module):
    ...
    Args:
        ...
        offload_config (OffloadConfig):
            ...
            only supports specifying SSD offload as an option.
            ...
            for p in self.params:
                if not p._is_sharded:  # e.g., when world_size == 1
                    ...
                    if hasattr(dist, "_all_gather_base") and enable_nccl_base_collectives:
                        ...
                        print(f"output_tensor.dtype {output_tensor.dtype} p_data {p_data.dtype}")
